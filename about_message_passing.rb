...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # ALSO: to avoid calling private methods - not necessary after ruby 2.1??!
    assert_equal true, mc.public_send(:caught?)

    # THINK ABOUT IT:
    #
    # Why does Ruby provide both send and __send__ ?
    # BECAUSE: send method can be overriden and is
    # in certain classes e.g. socket, mailers?
  end
