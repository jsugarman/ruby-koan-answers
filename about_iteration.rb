...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # adds an element to the end of the array and executes the block accepting 
    # the product of each iteration as and in out parameter to the next iteration
    # thereby doing away with the need for a separate variable external to the block
  end
  ...
  def test_all_iteration_methods_work_on_any_collection_not_just_arrays
    ...
    # alternative but involves creating a local variable??? so not as good
  ...
  # you would have to make 2 calls to the File library, one to open one to read
