...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # THINK ABOUT IT:
    #
    # When would * fail to match? only when it 
    # answer: when it bounded by other characters that must match
    assert_equal nil, "abc"[/az*c/]
  end
  ...
  #
  # Why?
  # answer: greedy because they match the longest/biggest string that meets the pattern, even though this might contain 
  #         repetitions of the pattern. 
  # e.g.   greedy: "<h1>hi<h1><h1>there<h1>"[/<h1>.*<h1>/]  --> "<h1>hi<h1><h1>there<h1>"
  # e.g.   lazy  : "<h1>hi<h1><h1>there<h1>"[/<h1>.*?<h1>/] --> "<h1>hi<h1>"
  # ------------------------------------------------------------------
  ...
  def test_slash_a_anchors_to_the_start_of_the_string
    ...
    assert_equal " start", " start end"[/\A\sstart/]
